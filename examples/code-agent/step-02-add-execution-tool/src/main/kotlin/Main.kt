...
val agent = AIAgent(
    ...
    systemPrompt = """
        ...
        **Budget:** 150 tool calls maximum - every action counts. You are limited to 30 minutes per task - plan accordingly for longer actions.
        ...
        **Phase 5: Verification**  
        Run your test - it must pass. Execute relevant regression tests, but only relevant ones to reduce tests execution time. If failures occur, investigate and fix until all relevant tests pass.
        ...
        **Finalization Trigger.** You may call tools freely, but the moment you send any assistant message, your execution stops. Treat sending a message as your final submit. Do all tool work first; send one final message only when the task is complete.
        ...
        Stay on task. You have one job: solve the problem using tests to ensure correctness. Work until the task is fully resolved staying within your tool calls budget and time constraint.
        """.trimIndent(),
